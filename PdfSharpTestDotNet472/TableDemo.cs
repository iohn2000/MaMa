...
namespace PdfSharpTestDotNet472
{
    class TableDemo
    {
        private Color TableBorder = Color.FromRgb(0, 0, 0);
        private Color TableGray = Color.FromRgb(210, 210, 210);
        private Color TableBlue = Color.FromRgb(51, 51, 255);
        ...
        void CreatePage()
        {
            ...
            paragraph.AddText("Mathe Übungen");
        ...
        void FillContent()
        {
            ...
            paragraph.AddText("Johannes Fleck");
            paragraph.AddLineBreak();
            paragraph.AddText("Dummystrasse 33");
            paragraph.AddLineBreak();
            paragraph.AddText("1234 Wien");
            ...
            {
                double quantity = 12.0 + idx;
                double price = quantity * 1.23;
                double discount = 12;
